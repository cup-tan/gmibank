...
@JsonIgnoreProperties(ignoreUnknown = true) // hata yapilmis olabilir, city unutuldu, hata verir, gormezden gelmek icin
public class Customer1 {
    ...
    public Customer1 getCountry() {
        return country;
    }

    public void setCountry(Customer1 country) {
